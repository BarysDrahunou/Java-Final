...
public final class VariablesConstants {

    public static final int INITIAL_YEAR_VALUE = 1;
    public static final int INITIAL_MONTH_VALUE = 1;
    public static final int LAST_MONTH_VALUE = 12;
    public static final int MONTHS_TO_RAISE_EXPERIENCE_BONUS = 3;
    public static final int EXPERIENCE_BONUS_MULTIPLIER = 10;
    ...
    public static final int LOWER_FINE_BOUND = -10;
